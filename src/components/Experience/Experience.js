            ...
            <section id="experience" className="experiencePage">
                <Fade bottom duration={1000} delay={500} distance="30px"> 
                    ...
                    <Container className="experienceContainer">
                        <Tabs fill defaultActiveKey="work5" id="workExperienceTabs" className="experienceTabContainer">
                            <Tab eventKey="work5" title="AMD" tabClassName="experienceTab">
                                <div className="jobTitle">
                                    Silicon Design Engineer 2 | <span className="highlight">AMD</span>
                                </div>
                                <div className="date">
                                    July 2023 - Present
                                </div>
                                <ul className="jobDescription">
                                    ...
                                    <li>
                                        Utilized Perl for infrastructure, build-flow methodology, integration, and uniquification to support IP bring-up
                                    </li>
                                </ul>
                            </Tab>
